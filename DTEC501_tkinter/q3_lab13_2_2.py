...
def instruction():
    showinfo(None, "I've thought of a number between {} and  {}.\nYou have {} guesses in which to guess it.".format(min_random_number, '5', max_guesses))
...
guess_button = Button(root_window, text="Enter guess", width=btn_size, command=process_guess)
guess_button.pack()

# Instructions
instruct_btn = Button(root_window, text="Display instructions", width=btn_size, command=instruction)
instruct_btn.pack()
